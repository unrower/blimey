;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="0aa6146611f55a1b340b7012862df30a";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["YJU1PZoexC0k"]={appId:"NSNxwgSQIL9H",scope:{}};;CloudflareApps.installs["YJU1PZoexC0k"].options={"countPosition":"none","location":{"method":"prepend","selector":"body"},"shape":"small","type":"hover"};;CloudflareApps.installs["YJU1PZoexC0k"].selectors={"location.selector":"body"};;if(CloudflareApps.matchPage(CloudflareApps.installs['YJU1PZoexC0k'].URLPatterns)){(function(modules){var installedModules={};function __webpack_require__(moduleId){if(installedModules[moduleId]){return installedModules[moduleId].exports;}
...
var IS_PREVIEW="YJU1PZoexC0k"==='preview'
var options=CloudflareApps.installs['YJU1PZoexC0k'].options
...
window.CloudflareApps.installs['YJU1PZoexC0k'].scope={setOptions:function setOptions(nextOptions){options=nextOptions
